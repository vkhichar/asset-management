...
insert into assets (status,category,purchase_at,purchase_cost,name,specifications) values ('Maintenance','Laptop','01/10/2017',40000,'IBM Thinkpad','{"RAM":"4GB","HDD":"500GB","Generation":"i5"}');
...
insert into assets (status,category,purchase_at,purchase_cost,name,specifications) values ('Not Active','Laptop','29/12/2016',450,'Logitech','{"Wireless":"No","Sensor":"Laser"}');
